...
#            '''
    ...
    def getChordName(self, imap):
        ...
        r = imap['R']
        if len(imap) == 2:
            if   'b2' in imap:                                 return '{} b2'.format(r)     # b2 interval
            elif  '2' in imap:                                 return  '{} 2'.format(r)     #  2 interval
            elif 'm3' in imap:                                 return '{} m3'.format(r)     # m3 interval
            elif 'M3' in imap:                                 return  '{} 3'.format(r)     # M3 interval
            elif  '4' in imap:                                 return  '{} 4'.format(r)     #  4 interval
            elif 'b5' in imap:                                 return '{} b5'.format(r)     # b5 interval (#4)
            elif  '5' in imap:                                 return  '{} 5'.format(r)     #  5 interval (power)
            elif 'a5' in imap:                                 return '{} #5'.format(r)     # #5 interval (b6)
